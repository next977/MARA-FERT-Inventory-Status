		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#SYNCzcdmmim4000-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SYNCzcdmmim4000-display": {
								"semanticObject": "SYNCzcdmmim4000",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=SYNC.zcdmmim4000",
									"url": sap.ui.require.toUrl("SYNC/zcdmmim4000")
								}
							}
						}
					}
